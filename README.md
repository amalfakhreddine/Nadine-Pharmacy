# Nadine Parapharmacy Website

## Files
- `index.html`: customer shop
- `admin.html`: private parapharmacy dashboard
...
This build adds:
- Free parapharmacy pickup or Tripoli-only home delivery.
...
This version adds Firestore-backed customer profiles and one shared admin profile stored at `settings/adminProfile`. Every authorised admin can read and edit the shared parapharmacy identity, phone number and job title. Publish the included Firestore rules.
