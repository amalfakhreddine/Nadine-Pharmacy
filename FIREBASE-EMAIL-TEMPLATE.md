...
> A password-reset email was sent. Please check your inbox. (Because this email service is newly configured, the message may occasionally appear in your Spam or Junk folder.)

Note: Firebase controls the actual sender address on the free built-in email service. This template changes the visible subject and email content, but it does not remove the Firebase noreply sender.
